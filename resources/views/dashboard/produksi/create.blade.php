...
<div class="card card-info">
  ...
  <form action="{{ route('produksi.store') }}" class="form-horizontal" method="POST">
    @csrf
    <div class="card-body">
      ...
      <div class="form-group row">
        ...
        <br><br>
        <div class="col-sm-10">
          <input type="date" class="form-control" name="tanggal" id="tanggal" placeholder="Tanggal Produksi">
        </div>
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="produksi" id="produksi" placeholder="Produksi">
        </div>
      </div>
