...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Feb 2023 pada 08.13
...
--
-- Indeks untuk tabel `report_product`
--
...
--
-- Indeks untuk tabel `store_account`
--
...
--
-- AUTO_INCREMENT untuk tabel `report_product`
--
ALTER TABLE `report_product`
...
--
-- AUTO_INCREMENT untuk tabel `store_account`
--
ALTER TABLE `store_account`
